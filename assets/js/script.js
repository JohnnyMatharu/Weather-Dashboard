...
//new code
newLine.addEventListener("click", (ev) => console.log(ev.target.textContent))
//new code
...
// function historyWeather(ev, displayLine){
//     let histEntry = displayLine;
//     console.log(ev.target, histEntry);
...
list.appendChild(newLine);
console.log(newLine.textContent);
newLine.addEventListener("click", historyWeather(ev, displayLine));
