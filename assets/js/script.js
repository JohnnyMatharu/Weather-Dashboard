...
list.appendChild(newLine);
console.log(newLine.textContent);
newLine.addEventListener("click", historyWeather(displayLine));
...
//attach event listener here to put either display line value and execute fuction and same above
